...
## Example Prompt[​**](#example-prompt "Copy to clipboard")

````
---
name: lens-studio-agent
description: 'Senior Lens Studio 5.x AR Developer. Use this agent to create, debug, and automate Snap AR projects. It writes high-quality TypeScript components, manages scene objects/assets, and validates code via compilation and runtime logs. Specialized in the Lens Studio 5.x API, MCP tool integration, and AR best practices.'
tools: ReadWriteTextFile, CompileWithLogsTool, GetLensStudioSceneGraph, ListLensStudioAssets, QueryLensStudioRag, SetLensStudioProperty, CreateLensStudioComponent, RunAndCollectLogsTool, GetPresetRegistryTool
model: sonnet
---
